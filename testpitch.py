...
color_library = {
    (14.0, 16.75): RGB[GREEN],       # C0
    (16.76, 18.0): RGB[CYAN2],       # C#0
    (18.1, 18.90): RGB[ALICEBLUE],   # D0
    (18.91, 19.90): RGB[BLUE2],       # D#0
    (19.91, 21.75): RGB[PURPLE1],     # E0
    (21.76, 22.47): RGB[PURPLE],      # F0
    (22.48, 23.80): RGB[BROWN],       # F#0
    (23.81, 25.23): RGB[BROWN2],        # G0
    (25.24, 26.73): RGB[ORANGERED1],   # G#0
    (26.74, 28.31): RGB[ORANGE],      # A0
    (28.32, 30.00): RGB[YELLOW2],     # A#0
    (30.01, 31.78): RGB[LIMEGREEN],   # B0
    (31.79, 33.67): RGB[GREEN],       # C1
    (33.68, 35.67): RGB[CYAN2],       # C#1
    (35.68, 37.80): RGB[ALICEBLUE],   # D1
    (37.81, 40.03): RGB[BLUE2],       # D#1
    (40.04, 42.42): RGB[PURPLE1],     # E1
    (42.43, 44.94): RGB[PURPLE],      # F1
    (44.95, 47.61): RGB[BROWN],       # F#1
    (47.62, 50.44): RGB[BROWN2],      # G1
    (50.45, 53.44): RGB[ORANGERED1],  # G#1
    (53.45, 56.62): RGB[ORANGE],      # A1
    (56.63, 59.99): RGB[YELLOW2],     # A#1
    (60.00, 63.56): RGB[LIMEGREEN],   # B1
    (63.58, 67.34): RGB[GREEN],       # C2
    (67.36, 71.34): RGB[CYAN2],       # C#2
    (71.36, 75.60): RGB[ALICEBLUE],   # D2
    (75.62, 80.06): RGB[BLUE2],       # D#2
    (80.06, 84.84): RGB[PURPLE1],     # E2
    (84.86, 89.88): RGB[PURPLE],      # F2
    (89.90, 95.22): RGB[BROWN],       # F#2
    (95.24, 100.88): RGB[BROWN2],      # G2
    (100.90, 106.88): RGB[ORANGERED1],  # G#2
    (106.90, 113.24): RGB[ORANGE],      # A2
    (113.26, 119.98): RGB[YELLOW2],     # A#2
    (120.00, 127.12): RGB[LIMEGREEN],   # B2
    (127.16, 134.68): RGB[GREEN],  # C3
    (134.72, 142.68): RGB[CYAN2],  # C#3
    (142.72, 151.20): RGB[ALICEBLUE],  # D3
    (151.24, 160.12): RGB[BLUE2],  # D#3
    (160.16, 169.68): RGB[PURPLE1],  # E3
    (169.72, 179.76): RGB[PURPLE],  # F3
    (179.80, 190.44): RGB[BROWN],  # F#3
    (190.48, 201.76): RGB[BROWN2],  # G3
    (201.80, 213.76): RGB[ORANGERED1],  # G#3
    (213.80, 226.48): RGB[ORANGE],  # A3
    (226.52, 239.96): RGB[YELLOW2],  # A#3
    (240.00, 254.24): RGB[LIMEGREEN],  # B3
    (254.32, 269.36): RGB[GREEN],  # C4
    (269.42, 285.36): RGB[CYAN2],  # C#4
    (285.44, 302.40): RGB[ALICEBLUE],  # D4
    (302.48, 320.24): RGB[BLUE2],  # D#4
    (320.32, 339.36): RGB[PURPLE1],  # E4
    (339.44, 359.52): RGB[PURPLE],  # F4
    (359.60, 380.88): RGB[BROWN],  # F#4
    (380.96, 403.52): RGB[BROWN2],  # G4
    (403.60, 427.52): RGB[ORANGERED1],  # G#4
    (427.60, 452.96): RGB[ORANGE],  # A4
    (453.04, 479.92): RGB[YELLOW2],  # A#4
    (480.00, 508.48): RGB[LIMEGREEN],  # B4
    (508.64, 538.72): RGB[GREEN],  # C5
    (538.88, 580.72): RGB[CYAN2],  # C#5
    (580.88, 604.80): RGB[ALICEBLUE],  # D5
    (604.96, 640.48): RGB[BLUE2],  # D#5
    (640.54, 678.72): RGB[PURPLE1],  # E5
    (678.88, 719.04): RGB[PURPLE],  # F5
    (719.20, 761.76): RGB[BROWN],  # F#5
    (761.90, 807.04): RGB[BROWN2],  # G5
    (807.20, 855.04): RGB[ORANGERED1],  # G#5
    (855.20, 905.92): RGB[ORANGE],  # A5
    (906.08, 959.84): RGB[YELLOW2],  # A#5
    (960.00, 1016.96): RGB[LIMEGREEN],  # B5
    (1017.28, 1077.44): RGB[GREEN],  # C6
    (1077.76, 1161.44): RGB[CYAN2],  # C#6
    (1161.76, 1209.60): RGB[ALICEBLUE],  # D6
    (1209.92, 1280.96): RGB[BLUE2],  # D#6
    (1281.08, 1357.44): RGB[PURPLE1],  # E6
    (1357.76, 1438.08): RGB[PURPLE],  # F6
    (1438.40, 1523.52): RGB[BROWN],  # F#6
    (1523.84, 1614.08): RGB[BROWN2],  # G6
    (1614.40, 1710.08): RGB[ORANGERED1],  # G#6
    (1710.40, 1811.84): RGB[ORANGE],  # A6
    (1812.16, 1919.68): RGB[YELLOW2],  # A#6
    (1920.00, 2033.92): RGB[LIMEGREEN],  # B6
    (2034.56, 2154.88): RGB[GREEN],  # C7
    (2155.52, 2322.88): RGB[CYAN2],  # C#7
    (2323.52, 2419.20): RGB[ALICEBLUE],  # D7
    (2419.84, 2561.92): RGB[BLUE2],  # D#7
    (2562.16, 2714.88): RGB[PURPLE1],  # E7
    (2715.52, 2876.16): RGB[PURPLE],  # F7
    (2876.80, 3037.04): RGB[BROWN],  # F#7
    (3037.68, 3228.16): RGB[BROWN2],  # G7
    (3228.80, 3420.16): RGB[ORANGERED1],  # G#7
    (3420.80, 3623.68): RGB[ORANGE],  # A7
    (3624.32, 3839.36): RGB[YELLOW2],  # A#7
    (3840.00, 4067.84): RGB[LIMEGREEN],  # B7
    (4069.12, 4309.76): RGB[GREEN],  # C8
    (4311.04, 4645.76): RGB[CYAN2],  # C#8
    (4647.04, 4838.40): RGB[ALICEBLUE],  # D8
    (4839.68, 5123.84): RGB[BLUE2],  # D#8
    (5052.32, 5429.76): RGB[PURPLE1],  # E8
    (5431.04, 5752.32): RGB[PURPLE],  # F8
    (5753.60, 6074.08): RGB[BROWN],  # F#8
    (6075.36, 6456.32): RGB[BROWN2],  # G8
    (6457.60, 6840.32): RGB[ORANGERED1],  # G#8
